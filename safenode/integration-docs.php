<?php
/**
 * SafeNode - Documentação de Integração com Hospedagem
...
$tabs = [
    'overview' => ['icon' => 'home', 'label' => 'Visão Geral'],
    'quickstart' => ['icon' => 'rocket', 'label' => 'Quick Start'],
    'api' => ['icon' => 'code', 'label' => 'API Reference'],
    'examples' => ['icon' => 'file-code', 'label' => 'Exemplos'],
...
<body class="min-h-screen">
    ...
    <div class="flex w-full relative">
            ...
            <div class="px-6 py-8">
                ...
                <nav class="space-y-0.5 mb-8">
                    ...
                    <a 
                        ...
                        class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg text-[14px] font-medium <?php echo $activeTab === $tabKey ? 'active text-white' : 'text-zinc-400'; ?>"
                    >
        ...
        <div class="lg:hidden fixed bottom-6 right-6 z-50">
            <button onclick="toggleMobileMenu()" class="w-14 h-14 rounded-full bg-white text-black flex items-center justify-center shadow-2xl hover:scale-105 transition-transform active:scale-95">
        ...
        <div id="mobile-sidebar" class="lg:hidden fixed inset-0 z-40 hidden">
            <div class="absolute inset-0 bg-black/60 backdrop-blur-md" onclick="toggleMobileMenu()"></div>
            <div class="absolute inset-y-0 left-0 w-80 max-w-[85vw] bg-black border-r border-white/[0.08] overflow-y-auto">
                <div class="px-6 py-8">
                    <!-- Logo Mobile -->
                    <div class="mb-10">
                        <a href="index.php" class="flex items-center gap-3 group">
                    ...
                    <div class="mb-8">
                        ...
                        <h1 class="text-[26px] font-bold text-white leading-tight tracking-tight">Integração</h1>
                    </div>
                    ...
                    <div class="pt-6 border-t border-white/[0.06] space-y-1">
                        <a href="docs.php" onclick="toggleMobileMenu()" class="flex items-center gap-2.5 px-3 py-2 text-[14px] text-zinc-400 hover:text-white transition-colors rounded-lg hover:bg-white/[0.03]">
                            <i data-lucide="book" class="w-4 h-4"></i>
                            <span>Documentação</span>
                        </a>
                        <a href="index.php" onclick="toggleMobileMenu()" class="flex items-center gap-2.5 px-3 py-2 text-[14px] text-zinc-400 hover:text-white transition-colors rounded-lg hover:bg-white/[0.03]">
                            <i data-lucide="arrow-left" class="w-4 h-4"></i>
                            <span>Voltar</span>
                        </a>
                        <a href="survey.php" onclick="toggleMobileMenu()" class="flex items-center gap-2.5 px-3 py-2 text-[14px] text-zinc-400 hover:text-white transition-colors rounded-lg hover:bg-white/[0.03]">
                            <i data-lucide="message-square" class="w-4 h-4"></i>
                            <span>Pesquisa</span>
                        </a>
                    </div>
        ...
        <main class="flex-1 min-w-0 relative">
            <div class="max-w-4xl mx-auto px-6 lg:px-16 py-12 lg:py-20">
                ...
                <div id="tab-overview" class="tab-content <?php echo $activeTab === 'overview' ? 'active' : ''; ?>">
                    ...
                    <!-- Substituindo grid de cards por diagrama radial estilo da imagem fornecida -->
                    <div class="mt-24">
                        ...
                        <!-- Improved SVG connections with proper positioning and animated data flows -->
                ...
                <!-- Tab: Quick Start -->
                <div id="tab-quickstart" class="tab-content <?php echo $activeTab === 'quickstart' ? 'active' : ''; ?>">
...
echo json_encode($result, JSON_PRETTY_PRINT);</code></pre>
  ...
  "variables": {
    ...
    "link": "https://exemplo.com/confirmar?token=abc"
                ...
                <!-- Tab: Examples -->
                <div id="tab-examples" class="tab-content <?php echo $activeTab === 'examples' ? 'active' : ''; ?>">
                    <div class="mb-16">
    ...
    },
    {
      headers: {
        ...
        'Content-Type': 'application/json'
                ...
                <!-- Tab: Docker -->
                <div id="tab-docker" class="tab-content <?php echo $activeTab === 'docker' ? 'active' : ''; ?>">
                    <div class="mb-16">
