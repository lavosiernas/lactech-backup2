...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 15/01/2026 às 11:10
...
--
-- Estrutura para tabela `safenode_maintenance_emails`
--

CREATE TABLE `safenode_maintenance_emails` (
  `id` int(11) NOT NULL,
...
--
-- Índices de tabela `safenode_maintenance_emails`
--
ALTER TABLE `safenode_maintenance_emails`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de tabela `safenode_maintenance_emails`
--
ALTER TABLE `safenode_maintenance_emails`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
