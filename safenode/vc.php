...
// Ano 2026 - apenas 5 dias de dados (Janeiro)
$dailyRevenue2025 = 650.00; // Receita diária média em 2025
$revenue5Days = 3250.00; // Receita dos primeiros 5 dias de janeiro 2026
$annualRevenue = $revenue5Days; // Receita anual 2026 (apenas 5 dias até agora)
$monthlyRevenue = $revenue5Days; // Receita mensal janeiro 2026 (apenas 5 dias)
$dailyRevenue = $dailyRevenue2025; // Receita diária média baseada em 2025
$growthRate = 8.3; // Percentual de crescimento
$totalCustomers = 1185;
$activeSubscriptions = 847;

// Custos (hospedagem, servidor e outros serviços)
$monthlyCosts = 9850.00; // Custos mensais
$annualCosts = $monthlyCosts * 12; // Custos anuais (12 meses)

// Lucro líquido (receita - custos)
// Para 2026, considerar apenas os custos proporcionais aos 5 dias
$dailyCosts = $monthlyCosts / 30; // Custo diário
$costs5Days = $dailyCosts * 5; // Custos dos 5 dias
$annualProfit = $revenue5Days - $costs5Days;
$monthlyProfit = $revenue5Days - $costs5Days;

// Dados mensais para gráfico (últimos 12 meses)
$monthlyData = [
    ['month' => 'Fev', 'revenue' => 18200.00],
    ['month' => 'Mar', 'revenue' => 18750.00],
    ['month' => 'Abr', 'revenue' => 19100.00],
    ['month' => 'Mai', 'revenue' => 19800.00],
    ['month' => 'Jun', 'revenue' => 20300.00],
    ['month' => 'Jul', 'revenue' => 21100.00],
    ['month' => 'Ago', 'revenue' => 18600.00],
    ['month' => 'Set', 'revenue' => 19200.00],
    ['month' => 'Out', 'revenue' => 19900.00],
    ['month' => 'Nov', 'revenue' => 20500.00],
    ['month' => 'Dez', 'revenue' => 20150.00],
    ['month' => 'Jan', 'revenue' => $revenue5Days] // Apenas 5 dias de janeiro 2026
];
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="stat-card p-6">
                ...
                <div>
                    ...
                    <p class="text-xs text-zinc-500">Período 2026 (5 dias)</p>
                </div>
                <div class="mt-5 pt-4 border-t border-white/10">
                    <div class="flex items-center justify-between mb-2">
                        <span class="text-xs text-zinc-500">Progresso do ano</span>
                        <span class="text-xs font-medium text-white">0.4%</span>
                    </div>
                    <div class="w-full bg-zinc-900 rounded-full h-1">
                        <div class="bg-white/20 h-1 rounded-full" style="width: 0.4%"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="stat-card green p-6">
                ...
                <div>
                    ...
                    <p class="text-xs text-zinc-500">Janeiro 2026 (5 dias)</p>
                </div>
                <div class="mt-5 pt-4 border-t border-white/10">
                    <div class="flex items-center justify-between">
                        <span class="text-xs text-zinc-500">Projeção mês completo</span>
                        <span class="text-xs font-medium text-white">R$ 19.500</span>
                    </div>
                </div>
            </div>
            ...
            <div class="stat-card orange p-6">
                ...
                <div>
                    ...
                    <p class="text-xs text-zinc-500">Média baseada em 2025</p>
                </div>
                <div class="mt-5 pt-4 border-t border-white/10">
                    <div class="flex items-center justify-between">
                        <span class="text-xs text-zinc-500">Hoje</span>
                        <span class="text-xs font-medium text-white">R$ 650,00</span>
                    </div>
                </div>
            </div>
            ...
            <div class="stat-card purple p-6">
                ...
                <div class="mt-5 pt-4 border-t border-white/10">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-xs font-medium text-white">+8</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="stat-card p-6">
                ...
                <div>
                    ...
                    <p class="text-xs text-zinc-500">Receita: R$ <?php echo number_format($annualRevenue, 2, ',', '.'); ?> | Custos: R$ <?php echo number_format($costs5Days, 2, ',', '.'); ?> (5 dias)</p>
                </div>
                <div class="mt-5 pt-4 border-t border-white/10">
                    <div class="flex items-center justify-between mb-2">
            ...
            <div class="stat-card p-6">
                ...
                <div>
                    ...
                    <p class="text-xs text-zinc-500">Receita: R$ <?php echo number_format($monthlyRevenue, 2, ',', '.'); ?> | Custos: R$ <?php echo number_format($costs5Days, 2, ',', '.'); ?> (5 dias)</p>
                </div>
                <div class="mt-5 pt-4 border-t border-white/10">
                    <div class="flex items-center justify-between mb-2">
                        <span class="text-xs text-zinc-500">Margem de lucro</span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="glass-card p-6">
                ...
                <div class="mt-4 pt-4 border-t border-white/10 flex items-center justify-between text-xs">
                    ...
                    <span class="text-white font-medium">R$ 19.450/mês</span>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="p-4 rounded-lg border border-white/10 bg-white/5">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-base font-semibold text-white">R$ 170,00</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="glass-card p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm text-zinc-400">Meta Anual 2026</span>
                            <span class="text-base font-semibold text-white">R$ 240.000</span>
                        </div>
                        <p class="text-xs text-zinc-500">+9% vs 2025 (projeção)</p>
                    </div>
                </div>
            </div>
        </div>
