...
--
-- Host: 127.0.0.1
-- Tempo de geração: 04/11/2025 às 01:03
...
--
DELIMITER $$
DROP TRIGGER IF EXISTS `tr_animals_updated`$$
...
--
DELIMITER $$
DROP TRIGGER IF EXISTS `tr_heifer_costs_set_phase`$$
...
DELIMITER ;
DELIMITER $$
DROP TRIGGER IF EXISTS `tr_heifer_costs_updated`$$
...
--
DELIMITER $$
DROP TRIGGER IF EXISTS `tr_create_pregnancy_control`$$
...
DELIMITER ;
DELIMITER $$
DROP TRIGGER IF EXISTS `tr_update_reproductive_status_insemination`$$
...
--
DELIMITER $$
DROP TRIGGER IF EXISTS `tr_create_maternity_alert`$$
...
--
DELIMITER $$
DROP TRIGGER IF EXISTS `tr_users_updated`$$
...
(8, 2, '7hk5697dc859uopd1c68oggcfp', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-03 21:01:30', '2025-11-03 20:56:30');
