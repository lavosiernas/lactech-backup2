-- =====================================================
-- LACTECH - BANCO DE DADOS COMPLETO FINAL
-- =====================================================
-- Execute este arquivo no SQL Editor do Supabase
-- Este script recria todo o banco do zero
-- =====================================================
...
-- =====================================================
-- LIMPEZA INICIAL (REMOVER TABELAS EXISTENTES)
-- =====================================================
...
DROP TRIGGER IF EXISTS update_artificial_inseminations_updated_at ON artificial_inseminations;
...
CREATE INDEX idx_farms_cnpj ON farms(cnpj);
...
CREATE INDEX idx_milk_production_farm_id ON milk_production(farm_id);
CREATE INDEX idx_milk_production_date ON milk_production(production_date);
CREATE INDEX idx_milk_production_user_id ON milk_production(user_id);
...
CREATE INDEX idx_cows_identification ON cows(identification);

-- Índices para artificial_inseminations
CREATE INDEX idx_inseminations_farm_id ON artificial_inseminations(farm_id);
CREATE INDEX idx_inseminations_cow_id ON artificial_inseminations(cow_id);
...
CREATE INDEX idx_pregnancies_cow_id ON pregnancies(cow_id);
...
DROP POLICY IF EXISTS "Users can manage milk production from their farm" ON milk_production;
...
DROP POLICY IF EXISTS "Users can manage quality tests from their farm" ON quality_tests;
...
-- Políticas para cows
DROP POLICY IF EXISTS "Users can manage cows from their farm" ON cows;
...
DROP POLICY IF EXISTS "Users can manage inseminations from their farm" ON artificial_inseminations;
...
DROP POLICY IF EXISTS "Users can manage pregnancies from their farm" ON pregnancies;
...
DROP POLICY IF EXISTS "Users can manage financial records from their farm" ON financial_records;
...
SELECT '🔄 Triggers para updated_at configurados' as triggers;
