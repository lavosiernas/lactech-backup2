    ...
    if (typeof lucide !== 'undefined') {
        ...
        <main class="flex-1 flex flex-col h-full overflow-hidden bg-dark-950">
            ...
            <div class="flex-1 overflow-y-auto p-8">
                ...
                <!-- Skeleton para última auditoria -->
                <div x-show="loading" class="bg-dark-800 border border-white/10 rounded-xl p-6 mb-6">
                    <div class="flex items-center justify-between mb-4">
                        <div class="skeleton-line" style="width: 150px; height: 24px;"></div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
                        ...
                        <div class="bg-dark-700 border border-white/5 rounded-lg p-4">
                            <div class="skeleton-line" style="width: 80px; height: 14px; margin-bottom: 8px;"></div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="border border-white/10 rounded-lg p-5">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex-1">
                                    <div class="flex items-center gap-3 mb-2">
                                        <div class="skeleton-line" style="width: 250px; height: 20px;"></div>
                                        <div class="skeleton-line" style="width: 70px; height: 20px;"></div>
                                        <div class="skeleton-line" style="width: 100px; height: 20px;"></div>
                                    </div>
                                    <div class="skeleton-line" style="width: 100%; height: 16px; margin-bottom: 4px;"></div>
                            ...
                            <div class="flex items-center justify-between pt-3 border-t border-white/5">
                                ...
                                <div class="skeleton-line" style="width: 150px; height: 36px;"></div>
                            </div>
                        </div>
                        <?php endfor; ?>
                    </div>
                ...
                <!-- Skeleton para histórico de auditorias -->
                <?php if (!empty($auditHistory)): ?>
                <div x-show="loading" class="bg-dark-800 border border-white/10 rounded-xl p-6 mt-6">
                    <div class="skeleton-line" style="width: 200px; height: 24px; margin-bottom: 16px;"></div>
