...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19/11/2025 às 20:04
...
(1, 'enabled', '1', 'boolean', 'Habilitar/Desabilitar SafeNode', 'general', 1, '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(2, 'mode', 'production', 'string', 'Modo de operação: production, development, testing', 'general', 1, '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(3, 'auto_block', '1', 'boolean', 'Bloquear IPs automaticamente quando detectar ameaças', 'detection', 1, '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(4, 'block_duration', '3600', 'integer', 'Duração do bloqueio em segundos (padrão: 1 hora)', 'detection', 1, '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(5, 'login_max_attempts', '5', 'integer', 'Máximo de tentativas de login antes de bloquear', 'rate_limit', 1, '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(6, 'login_window', '300', 'integer', 'Janela de tempo para tentativas de login em segundos (5 minutos)', 'rate_limit', 1, '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(7, 'api_rate_limit', '100', 'integer', 'Limite de requisições por minuto para API', 'rate_limit', 1, '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(8, 'api_rate_window', '60', 'integer', 'Janela de tempo para rate limit da API em segundos', 'rate_limit', 1, '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(9, 'threat_score_threshold', '70', 'integer', 'Score mínimo para considerar ameaça crítica (0-100)', 'detection', 1, '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(10, 'log_retention_days', '30', 'integer', 'Dias para manter logs antes de arquivar', 'general', 1, '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(11, 'cloudflare_sync', '1', 'boolean', 'Sincronizar bloqueios com Cloudflare', 'cloudflare', 1, '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(12, 'cloudflare_zone_id', '', 'string', 'Zone ID do Cloudflare', 'cloudflare', 1, '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(13, 'cloudflare_api_token', '', 'string', 'API Token do Cloudflare', 'cloudflare', 1, '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(14, 'alert_email', '', 'string', 'Email para receber alertas críticos', 'general', 1, '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(15, 'alert_threshold', '10', 'integer', 'Número de ameaças por hora para enviar alerta', 'general', 1, '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(16, 'enable_whitelist', '1', 'boolean', 'Habilitar sistema de whitelist', 'general', 1, '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(17, 'enable_statistics', '1', 'boolean', 'Coletar estatísticas para dashboard', 'general', 1, '2025-11-19 03:00:59', '2025-11-19 03:00:59');
...
(1, 'SQL Injection - UNION', '(?i)(unions+(alls+)?select)', 'sql_injection', 'critical', 1, 'Detecta tentativas de SQL Injection usando UNION SELECT', '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(2, 'SQL Injection - OR 1=1', '(?i)(sors+[\'\"]?d+[\'\"]?s*=s*[\'\"]?d+)', 'sql_injection', 'critical', 1, 'Detecta padrão OR 1=1 em SQL Injection', '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(3, 'SQL Injection - DROP TABLE', '(?i)(drops+table)', 'sql_injection', 'critical', 1, 'Detecta tentativas de DROP TABLE', '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(4, 'SQL Injection - DELETE FROM', '(?i)(deletes+from)', 'sql_injection', 'high', 1, 'Detecta tentativas de DELETE FROM', '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(5, 'SQL Injection - INSERT INTO', '(?i)(inserts+into)', 'sql_injection', 'high', 1, 'Detecta tentativas de INSERT INTO', '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(6, 'SQL Injection - UPDATE SET', '(?i)(updates+w+s+set)', 'sql_injection', 'high', 1, 'Detecta tentativas de UPDATE SET', '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(7, 'XSS - Script Tag', '(?i)(<script[^>]*>.*?</script>)', 'xss', 'critical', 1, 'Detecta tags <script> maliciosas', '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(8, 'XSS - JavaScript Event', '(?i)(onw+s*=s*[\'\"])', 'xss', 'high', 1, 'Detecta eventos JavaScript inline', '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(9, 'XSS - JavaScript Protocol', '(?i)(javascripts*:)', 'xss', 'high', 1, 'Detecta protocolo javascript:', '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(10, 'XSS - Iframe', '(?i)(<iframe[^>]*>)', 'xss', 'medium', 1, 'Detecta tags <iframe> suspeitas', '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(11, 'Path Traversal - ../', '(../|..\\\\)', 'path_traversal', 'high', 1, 'Detecta tentativas de path traversal', '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(12, 'Path Traversal - Absolute Path', '(?i)(/etc/|/var/|/usr/|c:\\\\windows)', 'path_traversal', 'high', 1, 'Detecta caminhos absolutos suspeitos', '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(13, 'Command Injection - Pipe', '(||||&|&&|;)', 'command_injection', 'high', 1, 'Detecta caracteres de pipe e comandos', '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(14, 'Command Injection - System Commands', '(?i)(system|exec|shell_exec|passthru|proc_open)', 'command_injection', 'critical', 1, 'Detecta funções de sistema PHP', '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(15, 'Suspicious - PHP Code', '(?i)(<?php|<?)', 'suspicious_pattern', 'high', 1, 'Detecta código PHP em requisições', '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(16, 'Suspicious - Base64', '(?i)([A-Za-z0-9+/]{100,}={0,2})', 'suspicious_pattern', 'medium', 1, 'Detecta strings Base64 suspeitas', '2025-11-19 03:00:59', '2025-11-19 03:00:59'),
(17, 'Suspicious - Hex Encoding', '(?i)(\\x[0-9a-f]{2})', 'suspicious_pattern', 'medium', 1, 'Detecta codificação hexadecimal suspeita', '2025-11-19 03:00:59', '2025-11-19 03:00:59');
...
(1, 'admin', 'admin@safenode.cloud', '$2y$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Administrador SafeNode', 'admin', 1, 1, '2025-11-19 03:01:32', NULL, '2025-11-19 03:01:32', '2025-11-19 03:01:32');
