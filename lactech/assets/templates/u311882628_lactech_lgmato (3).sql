...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 28/12/2025 às 15:37
...
--
-- Banco de dados: `u311882628_lactech_lgmato`
--
...
(27, 'V050', 'Emilly', 'Girolando', 'femea', '2023-06-15', 42.50, 5, 12, 'Novilha', NULL, 'saudavel', 'vazia', '2023-06-15', NULL, NULL, 1, 'Novilha com excelente pedigree para reprodução', 1, '2025-11-02 04:35:42', '2025-11-11 03:48:32');
...
CREATE TABLE `bulls` (
  ...
  `rfid_code` varchar(50) DEFAULT NULL COMMENT 'Código RFID',
  `earring_number` varchar(50) DEFAULT NULL COMMENT 'Número de brinco',
  `name` varchar(255) DEFAULT NULL,
  `breed` varchar(100) NOT NULL,
  `birth_date` date NOT NULL,
  ...
  `grandsire_father` varchar(100) DEFAULT NULL COMMENT 'Avô paterno',
  `granddam_father` varchar(100) DEFAULT NULL COMMENT 'Avó paterna',
  `dam` varchar(100) DEFAULT NULL,
  `grandsire_mother` varchar(100) DEFAULT NULL COMMENT 'Avô materno',
  `granddam_mother` varchar(100) DEFAULT NULL COMMENT 'Avó materna',
  ...
  `genetic_evaluation` text DEFAULT NULL COMMENT 'Avaliação genética detalhada',
  `behavior_notes` text DEFAULT NULL COMMENT 'Observações sobre comportamento',
  `aptitude_notes` text DEFAULT NULL COMMENT 'Aptidão e características',
  ...
  `notes` text DEFAULT NULL,
  `location` varchar(255) DEFAULT NULL COMMENT 'Localização física',
  `farm_id` int(11) NOT NULL DEFAULT 1,
  `is_active` tinyint(1) NOT NULL DEFAULT 1,
  `is_breeding_active` tinyint(1) DEFAULT 1 COMMENT 'Ativo para reprodução',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `bulls` (`id`, `bull_code`, `bull_name`, `bull_number`, `rfid_code`, `earring_number`, `name`, `breed`, `birth_date`, `weight`, `body_score`, `genetic_code`, `sire`, `grandsire_father`, `granddam_father`, `dam`, `grandsire_mother`, `granddam_mother`, `genetic_merit`, `milk_production_index`, `fat_production_index`, `protein_production_index`, `fertility_index`, `health_index`, `genetic_evaluation`, `behavior_notes`, `aptitude_notes`, `photo_url`, `status`, `purchase_date`, `purchase_price`, `sale_date`, `sale_price`, `source`, `genetic_value`, `notes`, `location`, `farm_id`, `is_active`, `is_breeding_active`, `created_at`, `updated_at`) VALUES
(1, NULL, NULL, 'B001', NULL, NULL, 'Touro Elite', 'Holandês', '2018-12-01', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'ativo', NULL, NULL, NULL, NULL, 'proprio', 'Alto valor genético', NULL, NULL, 1, 1, 1, '2025-10-13 14:21:52', '2025-10-13 14:21:52'),
(2, NULL, NULL, 'B002', NULL, NULL, 'Inseminação Premium', 'Gir', '2017-06-15', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'ativo', NULL, NULL, NULL, NULL, 'inseminacao', 'Sêmen importado', NULL, NULL, 1, 1, 1, '2025-10-13 14:21:52', '2025-10-13 14:21:52'),
(3, NULL, NULL, 'B003', NULL, NULL, 'Champion Elite', 'Holandês', '2017-03-10', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'ativo', NULL, NULL, NULL, NULL, 'inseminacao', 'Alto valor genético para produção', 'Sêmen importado da Holanda', NULL, 1, 1, 1, '2025-10-27 20:13:07', '2025-10-27 20:13:07'),
(4, NULL, NULL, 'B004', NULL, NULL, 'Gir Premium', 'Gir', '2016-08-20', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'ativo', NULL, NULL, NULL, NULL, 'inseminacao', 'Excelente para adaptação tropical', 'Sêmen de touro premiado', NULL, 1, 1, 1, '2025-10-27 20:13:07', '2025-10-27 20:13:07'),
(5, NULL, NULL, 'B005', NULL, NULL, 'Girolando Star', 'Girolando', '2018-01-15', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'ativo', NULL, NULL, NULL, NULL, 'proprio', 'Boa produção e adaptação', 'Touro próprio da fazenda', NULL, 1, 1, 1, '2025-10-27 20:13:07', '2025-10-27 20:13:07');
...
CREATE TABLE `bull_body_condition` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `bull_health_records` (
  `id` int(11) NOT NULL,
  `bull_id` int(11) NOT NULL,
  `record_date` date NOT NULL,
...
(1, 'Lagoa Do Mato', 'Aquiraz - Ceará', NULL, 'Proprietário Lagoa do Mato', 'Justiniano de Serpa, Aquiraz - State of Ceará, 61700-000, Brazil, CEP 61700-000, Brasil', NULL, 'contato@lactechsys.com', '2025-10-13 14:21:52', '2025-11-03 16:45:58');
...
--
-- Despejando dados para a tabela `google_accounts`
--

INSERT INTO `google_accounts` (`id`, `user_id`, `google_id`, `email`, `name`, `picture`, `is_primary`, `linked_at`, `unlinked_at`, `last_login_at`) VALUES
(1, 2, '115943975533213801187', 'slavosier298@gmail.com', 'Lavosier Silva', 'https://lh3.googleusercontent.com/a/ACg8ocLmIAT_o4DY75p14SM6C4-nMnGPsJtc1-v3XL7JAkQNCHvmG36V=s96-c', 1, '2025-11-05 01:27:35', NULL, '2025-12-07 05:46:07');
...
(1, 2, 1, '2025-01-01', NULL, 'inseminacao_artificial', 'João Técnico', NULL, NULL, NULL, NULL, NULL, 'IA', NULL, 'pendente', 'palpacao', NULL, NULL, 'vivo', NULL, NULL, NULL, NULL, 'Inseminação bem sucedida', 2, 1, '2025-10-27 20:13:08', '2025-11-02 01:15:07'),
(2, 4, 2, '2025-01-02', NULL, 'inseminacao_artificial', 'João Técnico', NULL, NULL, NULL, NULL, NULL, 'IA', NULL, 'pendente', 'palpacao', NULL, NULL, 'vivo', NULL, NULL, NULL, NULL, 'Inseminação de qualidade', 2, 1, '2025-10-27 20:13:08', '2025-11-02 01:15:07'),
(3, 5, 1, '2025-01-03', NULL, 'inseminacao_artificial', 'João Técnico', NULL, NULL, NULL, NULL, NULL, 'IA', NULL, 'pendente', 'palpacao', NULL, NULL, 'vivo', NULL, NULL, NULL, NULL, 'Não pegou, repetir', 2, 1, '2025-10-27 20:13:08', '2025-11-02 01:15:07'),
(4, 6, 2, '2025-01-04', NULL, 'inseminacao_artificial', 'João Técnico', NULL, NULL, NULL, NULL, NULL, 'IA', NULL, 'pendente', 'palpacao', NULL, NULL, 'vivo', NULL, NULL, NULL, NULL, 'Inseminação eficaz', 2, 1, '2025-10-27 20:13:08', '2025-11-02 01:15:07'),
(5, 7, 1, '2025-01-05', NULL, 'inseminacao_artificial', 'João Técnico', NULL, NULL, NULL, NULL, NULL, 'IA', NULL, 'pendente', 'palpacao', NULL, NULL, 'vivo', NULL, NULL, NULL, NULL, 'Boa inseminação', 2, 1, '2025-10-27 20:13:08', '2025-11-02 01:15:07');
...
CREATE TABLE `milk_production` (
  ...
  `recorded_by` int(11) NOT NULL,
  `farm_id` int(11) NOT NULL DEFAULT 1,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Data e hora de criação do registro',
...
(0, 2, 'Novo Registro de Volume', 'Junior alves registrou 600,00 litros na coleta da Manhã de 06/11/2025', 'gerente-completo.php#volume', 'success', 'info', 'medium', 0, 0, NULL, NULL, NULL, 'volume_records', NULL, 1, '2025-11-06 03:08:42', '2025-11-06 03:08:42');
...
INSERT INTO `otp_codes` (`id`, `user_id`, `code`, `action`, `is_used`, `used_at`, `expires_at`, `ip_address`, `user_agent`, `created_at`) VALUES
...
(3, 2, '967421', 'google_unlink', 0, NULL, '2025-11-03 22:01:28', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '2025-11-04 00:56:28'),
(4, 2, '510430', 'google_unlink', 0, NULL, '2025-11-03 22:03:58', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '2025-11-04 00:58:58'),
(5, 2, '117637', 'google_unlink', 0, NULL, '2025-11-03 22:04:34', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '2025-11-04 00:59:34'),
(6, 2, '566855', 'google_unlink', 0, NULL, '2025-11-03 22:45:17', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '2025-11-04 01:40:17'),
(7, 2, '071756', 'google_unlink', 0, NULL, '2025-11-03 23:09:46', '170.84.77.243', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', '2025-11-04 02:04:46'),
(8, 2, '176375', 'google_unlink', 0, NULL, '2025-11-04 12:38:59', '2804:18:7853:1491:cef:b2ff:fe8c:3a9b', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', '2025-11-04 15:33:59'),
(9, 2, '822382', 'google_unlink', 1, '2025-11-04 23:52:26', '2025-11-04 21:01:54', '170.84.77.248', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '2025-11-04 23:51:54'),
(10, 2, '855562', 'google_unlink', 1, '2025-11-05 01:16:25', '2025-11-04 22:25:50', '170.84.77.248', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '2025-11-05 01:15:50'),
(11, 2, '120824', 'google_unlink', 1, '2025-11-05 01:27:23', '2025-11-04 22:36:41', '170.84.77.248', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', '2025-11-05 01:26:41');
...
(0, 27, 1, 'pai', 5, NULL, 'Touro01', 'Holandês', 'Pai da Diamante - Reprodutor de alta qualidade genética', 1, '2025-11-02 04:35:42', '2025-11-02 04:35:42'),
(0, 27, 1, 'mae', 12, NULL, 'Estrela', 'Holandesa', 'Mãe da Diamante - Vaca de alta produção', 1, '2025-11-02 04:35:42', '2025-11-02 04:35:42'),
(0, 27, 2, 'avo_paterno', NULL, 'T002', 'Touro Excelente', 'Holandês', 'Avô paterno - Reprodutor premiado', 1, '2025-11-02 04:35:42', '2025-11-02 04:35:42'),
(0, 27, 2, 'avo_paterno_mae', NULL, 'V020', 'Super Vaca', 'Holandesa', 'Avó paterna - Vaca de alta produção', 1, '2025-11-02 04:35:42', '2025-11-02 04:35:42'),
(0, 27, 2, 'avo_materno', 5, NULL, 'Touro01', 'Holandês', 'Avô materno - Mesmo reprodutor do pai', 1, '2025-11-02 04:35:42', '2025-11-02 04:35:42'),
(0, 27, 2, 'avo_materno_mae', 1, NULL, 'Bella', 'Holandesa', 'Avó materna - Vaca produtora principal', 1, '2025-11-02 04:35:42', '2025-11-02 04:35:42');
...
INSERT INTO `pix_payments` (`id`, `txid`, `plan_id`, `plan_name`, `plan_value`, `pix_code`, `status`, `paid_at`, `verified_by`, `verified_at`, `created_at`, `updated_at`) VALUES
(1, 'LACPIX17621962048948METZZT', 'basico', 'Básico', 199.00, '00020101021226440014br.gov.bcb.pix0122slavosier298@gmail.com5204000053039865406199.005802BR5925LacTech - Sistema de Gest6008Brasília62300526LACPIX17621962048948METZZT6304B302', 'pendente', NULL, NULL, NULL, '2025-11-03 15:56:45', '2025-11-03 15:56:45'),
(2, 'LACPIX17621975921134OFDN7E', 'basico', 'Básico', 199.00, '00020101021226440014br.gov.bcb.pix0122slavosier298@gmail.com5204000053039865406199.005802BR5925LacTech - Sistema de Gest6008Brasília62300526LACPIX17621975921134OFDN7E6304B912', 'pendente', NULL, NULL, NULL, '2025-11-03 16:19:52', '2025-11-03 16:19:52'),
(3, 'LACPIX1762198666020KG2O0IZ', 'basico', 'Básico', 199.00, '00020101021226440014br.gov.bcb.pix0122slavosier298@gmail.com5204000053039865406199.005802BR5925LacTech - Sistema de Gest6008Brasília62300526LACPIX1762198666020KG2O0IZ63045379', 'pendente', NULL, NULL, NULL, '2025-11-03 16:37:48', '2025-11-03 16:37:48'),
(4, 'LACPIX1762205907446004QMWJ', 'profissional', 'Profissional', 399.00, '00020101021226440014br.gov.bcb.pix0122slavosier298@gmail.com5204000053039865406399.005802BR5925LacTech - Sistema de Gest6008Brasília62300526LACPIX1762205907446004QMWJ6304ACAF', 'pendente', NULL, NULL, NULL, '2025-11-03 18:38:27', '2025-11-03 18:38:27'),
(5, 'LACPIX1762206015065XQSB80H', 'profissional', 'Profissional', 399.00, '00020101021226440014br.gov.bcb.pix0122slavosier298@gmail.com5204000053039865406399.005802BR5925LacTech - Sistema de Gest6008Brasília62300526LACPIX1762206015065XQSB80H6304560E', 'pendente', NULL, NULL, NULL, '2025-11-03 18:40:15', '2025-11-03 18:40:15'),
(6, 'LACPIX1762206024151NFT44O6', 'basico', 'Básico', 199.00, '00020101021226440014br.gov.bcb.pix0122slavosier298@gmail.com5204000053039865406199.005802BR5925LacTech - Sistema de Gest6008Brasília62300526LACPIX1762206024151NFT44O6630453C8', 'pendente', NULL, NULL, NULL, '2025-11-03 18:40:24', '2025-11-03 18:40:24'),
(7, 'LACPIX1762206321395HHJ3RXM', 'basico', 'Básico', 199.00, '00020101021126440014br.gov.bcb.pix0122slavosier298@gmail.com5204000053039865406199.005802BR5925LacTech - Sistema de Gest6008Brasília62300526LACPIX1762206321395HHJ3RXM6304C8F4', 'pendente', NULL, NULL, NULL, '2025-11-03 18:45:21', '2025-11-03 18:45:21'),
(8, 'LACPIX1762206493358673OJZO', 'basico', 'Básico', 199.00, '00020101021226440014br.gov.bcb.pix0122slavosier298@gmail.com5204000053039865406199.005802BR5925LacTech - Sistema de Gest6008Brasília62290525LACPIX1762206493358673OJZ63041DAD', 'pendente', NULL, NULL, NULL, '2025-11-03 18:48:13', '2025-11-03 18:48:13'),
(9, 'BASICO-FIXO-1762207415384', 'basico', 'Básico', 199.00, '00020126580014BR.GOV.BCB.PIX0136ebabf96f-5162-4bd1-95c5-64ffa8e9bfed52040000530398654041.995802BR5924Francisco Lavosier Silva6009SAO PAULO62140510sfR94Rftgb6304A197', 'pendente', NULL, NULL, NULL, '2025-11-03 19:03:35', '2025-11-03 19:03:35'),
(10, 'LACPIX17622490165651', 'profissional', 'Profissional', 399.00, '00020101021226440014br.gov.bcb.pix0122slavosier298@gmail.com5204000053039865406399.005802BR5925LacTech - Sistema de Gest6009Brasília62240520LACPIX17622490165651630436B5', 'pendente', NULL, NULL, NULL, '2025-11-04 09:36:56', '2025-11-04 09:36:56'),
(11, 'LACPIX17626031458217', 'profissional', 'Profissional', 399.00, '00020101021226440014br.gov.bcb.pix0122slavosier298@gmail.com5204000053039865406399.005802BR5925LacTech - Sistema de Gest6009Brasília62240520LACPIX176260314582176304CAE5', 'pendente', NULL, NULL, NULL, '2025-11-08 08:59:05', '2025-11-08 08:59:05'),
(12, 'LACPIX17626031942313', 'profissional', 'Profissional', 399.00, '00020101021226440014br.gov.bcb.pix0122slavosier298@gmail.com5204000053039865406399.005802BR5925LacTech - Sistema de Gest6009Brasília62240520LACPIX17626031942313630431E8', 'pendente', NULL, NULL, NULL, '2025-11-08 08:59:54', '2025-11-08 08:59:54'),
(13, 'LACPIX17633327267512', 'profissional', 'Profissional', 399.00, '00020101021226440014br.gov.bcb.pix0122slavosier298@gmail.com5204000053039865406399.005802BR5925LacTech - Sistema de Gest6009Brasília62240520LACPIX1763332726751263047986', 'pendente', NULL, NULL, NULL, '2025-11-16 19:38:46', '2025-11-16 19:38:46'),
(14, 'LACPIX17633327317948', 'empresarial', 'Empresarial', 799.00, '00020101021226440014br.gov.bcb.pix0122slavosier298@gmail.com5204000053039865406799.005802BR5925LacTech - Sistema de Gest6009Brasília62240520LACPIX17633327317948630400D9', 'pendente', NULL, NULL, NULL, '2025-11-16 19:38:51', '2025-11-16 19:38:51'),
(15, 'BASICO-FIXO-1763332774472', 'basico', 'Básico', 199.00, '00020126580014BR.GOV.BCB.PIX0136ebabf96f-5162-4bd1-95c5-64ffa8e9bfed52040000530398654041.995802BR5924Francisco Lavosier Silva6009SAO PAULO62140510sfR94Rftgb6304A197', 'pendente', NULL, NULL, NULL, '2025-11-16 19:39:34', '2025-11-16 19:39:34'),
(16, 'BASICO-FIXO-1763346422419', 'basico', 'Básico', 199.00, '00020126580014BR.GOV.BCB.PIX0136ebabf96f-5162-4bd1-95c5-64ffa8e9bfed52040000530398654041.995802BR5924Francisco Lavosier Silva6009SAO PAULO62140510sfR94Rftgb6304A197', 'pendente', NULL, NULL, NULL, '2025-11-16 23:27:02', '2025-11-16 23:27:02');
...
INSERT INTO `security_audit_log` (`id`, `user_id`, `action`, `description`, `ip_address`, `user_agent`, `success`, `error_message`, `metadata`, `created_at`) VALUES
(1, 2, 'otp_generated', 'OTP gerado para ação: google_unlink', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 1, NULL, '{\"action\":\"google_unlink\",\"expires_at\":\"2025-11-02 21:41:24\"}', '2025-11-03 00:36:26'),
(2, 2, 'otp_generated', 'OTP gerado para ação: google_unlink', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 1, NULL, '{\"action\":\"google_unlink\",\"expires_at\":\"2025-11-02 21:41:30\"}', '2025-11-03 00:36:32'),
(3, 2, 'google_linked', 'Conta Google vinculada via OAuth: slavosier298@gmail.com', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 1, NULL, '{\"google_id\":\"115943975533213801187\",\"email\":\"slavosier298@gmail.com\"}', '2025-11-04 00:39:32'),
(4, 2, 'otp_generated', 'OTP gerado para ação: google_unlink - Email: slavosier298@gmail.com', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 1, NULL, '{\"action\":\"google_unlink\",\"email\":\"slavosier298@gmail.com\",\"expires_at\":\"2025-11-03 22:01:28\"}', '2025-11-04 00:56:28'),
(5, 2, 'otp_validation_failed', 'Tentativa de validação OTP inválida para ação: google_unlink', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 0, 'Tentativa de validação OTP inválida para ação: google_unlink', '{\"action\":\"google_unlink\",\"code_provided\":\"96****\"}', '2025-11-04 00:57:07'),
(6, 2, 'otp_generated', 'OTP gerado para ação: google_unlink - Email: slavosier298@gmail.com', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 1, NULL, '{\"action\":\"google_unlink\",\"email\":\"slavosier298@gmail.com\",\"expires_at\":\"2025-11-03 22:03:58\"}', '2025-11-04 00:58:58'),
(7, 2, 'otp_validation_failed', 'Tentativa de validação OTP inválida para ação: google_unlink', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 0, 'Tentativa de validação OTP inválida para ação: google_unlink', '{\"action\":\"google_unlink\",\"code_provided\":\"51****\"}', '2025-11-04 00:59:13'),
(8, 2, 'otp_generated', 'OTP gerado para ação: google_unlink - Email: slavosier298@gmail.com', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 1, NULL, '{\"action\":\"google_unlink\",\"email\":\"slavosier298@gmail.com\",\"expires_at\":\"2025-11-03 22:04:34\"}', '2025-11-04 00:59:35'),
(9, 2, 'otp_validation_failed', 'Tentativa de validação OTP inválida para ação: google_unlink', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 0, 'Tentativa de validação OTP inválida para ação: google_unlink', '{\"action\":\"google_unlink\",\"code_provided\":\"11****\"}', '2025-11-04 00:59:53'),
(10, 2, 'otp_generated', 'OTP gerado para ação: google_unlink - Email: slavosier298@gmail.com', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 1, NULL, '{\"action\":\"google_unlink\",\"email\":\"slavosier298@gmail.com\",\"expires_at\":\"2025-11-03 22:45:17\"}', '2025-11-04 01:40:17'),
(11, 2, 'otp_validation_failed', 'Tentativa de validação OTP inválida para ação: google_unlink', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 0, 'Tentativa de validação OTP inválida para ação: google_unlink', '{\"action\":\"google_unlink\",\"code_provided\":\"56****\"}', '2025-11-04 01:40:44'),
(12, 2, 'otp_generated', 'OTP gerado para ação: google_unlink - Email: slavosier298@gmail.com', '170.84.77.243', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', 1, NULL, '{\"action\":\"google_unlink\",\"email\":\"slavosier298@gmail.com\",\"expires_at\":\"2025-11-03 23:09:46\"}', '2025-11-04 02:04:47'),
(13, 2, 'otp_generated', 'OTP gerado para ação: google_unlink - Email: slavosier298@gmail.com', '2804:18:7853:1491:cef:b2ff:fe8c:3a9b', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', 1, NULL, '{\"action\":\"google_unlink\",\"email\":\"slavosier298@gmail.com\",\"expires_at\":\"2025-11-04 12:38:59\"}', '2025-11-04 15:34:00'),
(14, 2, 'otp_generated', 'OTP gerado para ação: google_unlink - Email: slavosier298@gmail.com', '170.84.77.248', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 1, NULL, '{\"action\":\"google_unlink\",\"email\":\"slavosier298@gmail.com\",\"expires_at\":\"2025-11-04 21:01:54\"}', '2025-11-04 23:51:54'),
(15, 2, 'otp_validated', 'OTP validado com sucesso para ação: google_unlink', '170.84.77.248', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 1, NULL, '{\"action\":\"google_unlink\"}', '2025-11-04 23:52:26'),
(16, 2, 'google_unlinked', 'Conta Google desvinculada', '170.84.77.248', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 1, NULL, '{\"email\":\"slavosier298@gmail.com\"}', '2025-11-04 23:52:26'),
(17, 2, 'google_linked', 'Conta Google vinculada via OAuth: slavosier298@gmail.com', '170.84.77.248', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 1, NULL, '{\"google_id\":\"115943975533213801187\",\"email\":\"slavosier298@gmail.com\"}', '2025-11-05 01:13:34'),
(18, 2, 'otp_generated', 'OTP gerado para ação: google_unlink - Email: slavosier298@gmail.com', '170.84.77.248', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 1, NULL, '{\"action\":\"google_unlink\",\"email\":\"slavosier298@gmail.com\",\"expires_at\":\"2025-11-04 22:25:50\"}', '2025-11-05 01:15:50'),
(19, 2, 'otp_validated', 'OTP validado com sucesso para ação: google_unlink', '170.84.77.248', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 1, NULL, '{\"action\":\"google_unlink\"}', '2025-11-05 01:16:25'),
(20, 2, 'google_unlinked', 'Conta Google desvinculada', '170.84.77.248', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 1, NULL, '{\"email\":\"slavosier298@gmail.com\"}', '2025-11-05 01:16:25'),
(21, 2, 'google_linked', 'Conta Google vinculada via OAuth: slavosier298@gmail.com', '170.84.77.248', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 1, NULL, '{\"google_id\":\"115943975533213801187\",\"email\":\"slavosier298@gmail.com\"}', '2025-11-05 01:16:45'),
(22, 2, 'otp_generated', 'OTP gerado para ação: google_unlink - Email: slavosier298@gmail.com', '170.84.77.248', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', 1, NULL, '{\"action\":\"google_unlink\",\"email\":\"slavosier298@gmail.com\",\"expires_at\":\"2025-11-04 22:36:41\"}', '2025-11-05 01:26:42'),
(23, 2, 'otp_validated', 'OTP validado com sucesso para ação: google_unlink', '170.84.77.248', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', 1, NULL, '{\"action\":\"google_unlink\"}', '2025-11-05 01:27:23'),
(24, 2, 'google_unlinked', 'Conta Google desvinculada', '170.84.77.248', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', 1, NULL, '{\"email\":\"slavosier298@gmail.com\"}', '2025-11-05 01:27:23'),
(25, 2, 'google_linked', 'Conta Google vinculada via OAuth: slavosier298@gmail.com', '170.84.77.248', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', 1, NULL, '{\"google_id\":\"115943975533213801187\",\"email\":\"slavosier298@gmail.com\"}', '2025-11-05 01:27:35');
...
CREATE TABLE `semen_catalog` (
  ...
  `straw_code` varchar(50) DEFAULT NULL COMMENT 'Código da palheta',
  `production_date` date NOT NULL,
  ...
  `concentration` decimal(10,2) DEFAULT NULL COMMENT 'Concentração (milhões/ml)',
...
INSERT INTO `semen_catalog` (`id`, `bull_id`, `batch_number`, `straw_code`, `production_date`, `collection_date`, `expiry_date`, `alert_sent`, `straws_available`, `straws_used`, `price_per_straw`, `supplier`, `storage_location`, `destination`, `quality_grade`, `motility`, `volume`, `concentration`, `genetic_tests`, `notes`, `farm_id`, `created_at`, `updated_at`) VALUES
(1, 1, 'SE001', NULL, '2024-12-01', NULL, '2025-12-01', 0, 50, 0, 150.00, 'SemenBrasil', 'Freezer A', NULL, 'A', NULL, NULL, NULL, 'Testes genéticos completos', 'Sêmen de alta qualidade', 1, '2025-10-27 20:13:08', '2025-10-27 20:13:08'),
(2, 2, 'SE002', NULL, '2024-12-01', NULL, '2025-12-01', 0, 40, 0, 150.00, 'SemenBrasil', 'Freezer A', NULL, 'A', NULL, NULL, NULL, 'Testes genéticos completos', 'Sêmen de alta qualidade', 1, '2025-10-27 20:13:08', '2025-10-27 20:13:08'),
(3, 3, 'SE003', NULL, '2024-12-01', NULL, '2025-12-01', 0, 30, 0, 120.00, 'SemenBrasil', 'Freezer B', NULL, 'A', NULL, NULL, NULL, 'Testes genéticos básicos', 'Sêmen de qualidade', 1, '2025-10-27 20:13:08', '2025-10-27 20:13:08');
...
CREATE TABLE `user_sessions` (
  ...
  `gps_latitude` decimal(10,8) DEFAULT NULL COMMENT 'Coordenada GPS precisa do navegador',
  `gps_longitude` decimal(11,8) DEFAULT NULL COMMENT 'Coordenada GPS precisa do navegador',
  `gps_accuracy` decimal(10,2) DEFAULT NULL COMMENT 'Precisão em metros'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `user_sessions` (`id`, `user_id`, `session_id`, `ip_address`, `user_agent`, `device_type`, `device_name`, `location`, `last_activity`, `created_at`, `latitude`, `longitude`, `isp`, `timezone`, `country_code`, `region_code`, `city`, `gps_latitude`, `gps_longitude`, `gps_accuracy`) VALUES
(1, 2, 'skq782sf8v09cm1g2p3krstd1i', '170.84.77.254', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-10-31 00:21:38', '2025-10-30 20:13:16', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 2, 'ca5uohkgu0k30a6b5g1tu6fpj7', '170.84.77.254', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-01 11:11:35', '2025-11-01 07:29:08', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 2, 'fs0iqgs70c74fv1cojcnhpu1bp', '170.84.77.254', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-01 23:21:02', '2025-11-01 22:15:23', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, 2, 'dd475anjd60buph47b8fui6uc9', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-02 20:34:47', '2025-11-02 18:35:39', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, 2, '2pc0ajfofddbsb2k27pnjh2djm', '138.204.185.248', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-03 13:49:04', '2025-11-02 20:39:37', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, 2, '88huajimfdq1o5covute8ucicf', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-03 20:51:00', '2025-11-03 19:05:17', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(8, 2, '7hk5697dc859uopd1c68oggcfp', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-03 21:01:30', '2025-11-03 20:56:30', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(9, 2, 'rbnurm32hsgc3659rfsor4rg8e', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-04 00:36:09', '2025-11-04 00:36:09', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(10, 2, 'c2h3qdhcq3hcsbo45amuf66jas', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-04 00:40:05', '2025-11-04 00:37:18', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(11, 2, '8i6uf8rptbk19i80vvetntg31q', '170.84.77.243', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-04 01:40:02', '2025-11-04 00:41:03', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12, 2, 'vsng8p3kn4u2lv919ohb2e1lev', '38.211.206.58', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Fortaleza, Ceará, Brazil', '2025-11-05 21:54:28', '2025-11-04 00:59:45', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(13, 2, 'cgrtbusioferg13pnsvjohas2n', '179.224.184.10', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Fortaleza, Ceará, Brazil', '2025-11-04 09:36:10', '2025-11-04 02:04:20', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(14, 2, 's3ihjkenlt8jr3tirmr4svslbm', '179.224.184.10', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Fortaleza, Ceará, Brazil', '2025-11-04 09:37:26', '2025-11-04 09:37:26', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(15, 2, 'kgahe65ftc413ge1l5r28qrm8b', '138.204.185.248', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Maranguape, Ceará, Brazil', '2025-11-04 10:13:15', '2025-11-04 10:13:15', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(16, 2, 'indap5ffu8bnlip1jvh1238a11', '177.25.117.30', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Fortaleza, Ceará, Brazil', '2025-11-04 14:04:25', '2025-11-04 14:04:25', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(17, 2, 'h3c8828ojutf8i9qfb5bqdqd7n', '177.25.117.120', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Fortaleza, Ceará, Brazil', '2025-11-04 15:33:45', '2025-11-04 15:33:45', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(18, 2, '0mdc1a0hkr8lm2joc4qr357trq', '170.84.77.248', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-04 23:51:21', '2025-11-04 23:31:13', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(19, 2, 'o0ar475muhtpj6679hejqmep9i', '170.84.77.248', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-05 01:13:14', '2025-11-05 00:23:36', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(20, 2, '5pldarssjq3qndark34egfk2ro', '170.84.77.248', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Maranguape, Ceará, Brazil', '2025-11-05 01:27:46', '2025-11-05 01:26:04', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(21, 2, 'goqjv07lkouie4egfmesnjjor9', '170.84.77.248', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Maranguape, Ceará, Brazil', '2025-11-05 08:26:36', '2025-11-05 08:24:52', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(22, 2, 'pb8089brnogdjefmkts3hnb36k', '138.204.184.70', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-05 17:45:52', '2025-11-05 17:25:04', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(23, 2, 'sto6fi4bb3blmn7m7onv0k92ls', '179.224.179.204', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Fortaleza, Ceará, Brazil', '2025-11-05 17:26:27', '2025-11-05 17:26:27', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(24, 2, 'k96oocus9od1fsu8paqcfaajtv', '138.204.184.70', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-05 18:54:41', '2025-11-05 18:54:23', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(25, 2, '1cc7e646dg32qgnmbvjghvj2fj', '138.204.184.70', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-05 18:55:07', '2025-11-05 18:55:07', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(26, 2, 'dj3he12e5bgo4upv4kam5bl1ub', '138.204.184.70', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-05 19:13:54', '2025-11-05 18:55:33', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(27, 2, 'u6e856fckk1tpcq5a19rrui3h3', '138.204.184.70', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-05 19:51:49', '2025-11-05 19:23:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(28, 2, '8bcit44vvr89eluab5ml24mgdm', '179.224.179.204', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Fortaleza, Ceará, Brazil', '2025-11-05 19:53:22', '2025-11-05 19:52:47', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(29, 2, 'i5j1onlsdn4pkp9hv9sjg4acl1', '170.84.77.248', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-05 21:47:18', '2025-11-05 21:47:18', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(30, 2, '82d8u1m6v7q371817cacsplras', '138.204.185.83', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'desktop', 'Chrome - 142.0.0.0 - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-18 16:13:26', '2025-11-05 21:50:21', -3.99780000, -38.73280000, 'Smart Solucoes em Telecomunicacoes', 'America/Fortaleza', 'BR', 'CE', 'Maranguape', -3.88956160, -38.66296320, 46054.38),
(31, 2, '08oct2pa9uin5lb3mfvnhj5l14', '170.84.77.248', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Maranguape, Ceará, Brazil', '2025-11-06 00:06:54', '2025-11-06 00:06:54', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(32, 2, '0s0pahme99uitknmml2f3p3mi1', '138.204.185.248', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Maranguape, Ceará, Brazil', '2025-11-06 07:34:01', '2025-11-06 07:33:31', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(33, 2, 'nj8g3h5vksn8e36tif4u06j2sm', '170.84.77.248', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Maranguape, Ceará, Brazil', '2025-11-06 23:12:40', '2025-11-06 23:12:09', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(34, 2, '60ffp8obv4t2816ppskb1ff9da', '170.84.77.248', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Maranguape, Ceará, Brazil', '2025-11-06 23:22:42', '2025-11-06 23:17:25', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(35, 2, 'hggj6poscq8nlf83ohi1dai2ud', '170.84.77.248', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Maranguape, Ceará, Brazil', '2025-11-06 23:24:09', '2025-11-06 23:23:43', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(36, 2, '2cf4joj9novrd61nl5u4o891d0', '177.25.122.112', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Fortaleza, Ceará, Brazil', '2025-11-07 08:21:38', '2025-11-07 08:17:35', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(37, 2, 'ipj79oheiu0kqqcj7lb31tetoi', '177.25.122.231', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Fortaleza, Ceará, Brazil', '2025-11-07 10:32:12', '2025-11-07 10:32:12', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(38, 2, 'ssg5kfgtvuf1jg8o90jj48k3ub', '170.84.77.248', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Maranguape, Ceará, Brazil', '2025-11-08 08:10:50', '2025-11-08 08:10:02', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(39, 2, 'ljort0fe3mm9q6j448ilcfkjs6', '170.84.77.248', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Maranguape, Ceará, Brazil', '2025-11-08 18:11:09', '2025-11-08 18:11:09', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(40, 2, '96op4n9nk6bmbhdunosetfr6fc', '170.84.77.241', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Maranguape, Ceará, Brazil', '2025-11-11 01:06:22', '2025-11-11 00:46:31', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(41, 2, 'ie5bblgi5qobgfgqsef6bdoqvd', '177.51.73.221', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K', 'Fortaleza, Ceará, Brazil', '2025-11-11 09:35:59', '2025-11-11 09:33:09', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(42, 2, 'q1eifpad4gbm6kpnr19sngg5mb', '170.84.77.246', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Mobile Safari/537.36', 'mobile', 'Android - K (Android 10)', 'Maranguape, Ceará, Brazil', '2025-12-07 02:55:19', '2025-11-12 16:51:15', -3.88610000, -38.68520000, 'Umplay Telecom', 'America/Fortaleza', 'BR', 'CE', 'Maranguape', NULL, NULL, NULL),
(43, 2, 't7td9rb754gq7fmc8gqmes0ip7', '138.204.185.248', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', 'desktop', 'Chrome - Windows 10/11', 'Maranguape, Ceará, Brazil', '2025-11-14 16:10:42', '2025-11-14 15:45:42', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
-- (Veja abaixo para a visão atual)
--
CREATE TABLE `v_bull_efficiency_ranking` (
`id` int(11)
...
-- (Veja abaixo para a visão atual)
--
CREATE TABLE `v_bull_statistics_complete` (
`id` int(11)
,`bull_number` varchar(50)
,`name` varchar(255)
,`breed` varchar(100)
...
--
-- Índices de tabela `bull_body_condition`
--
...
--
-- Índices de tabela `bull_coatings`
--
...
--
-- Índices de tabela `bull_documents`
--
...
--
-- Índices de tabela `bull_health_records`
--
...
--
-- Índices de tabela `bull_offspring`
--
...
--
-- Índices de tabela `google_accounts`
--
...
--
-- Índices de tabela `pix_payments`
--
...
--
-- Índices de tabela `security_audit_log`
--
...
--
-- Índices de tabela `semen_movements`
--
...
ALTER TABLE `volume_records`
  ...
  ADD KEY `fk_volume_records_farm` (`farm_id`);
...
--
-- AUTO_INCREMENT de tabela `milk_production`
--
ALTER TABLE `milk_production`
...
--
-- AUTO_INCREMENT de tabela `volume_records`
--
ALTER TABLE `volume_records`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Restrições para tabelas `semen_movements`
--
ALTER TABLE `semen_movements`
...
--
-- Restrições para tabelas `volume_records`
--
ALTER TABLE `volume_records`
  ADD CONSTRAINT `fk_volume_records_farm` FOREIGN KEY (`farm_id`) REFERENCES `farms` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
