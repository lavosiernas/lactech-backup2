...
/**
 * Página: Mais Opções
 * Página completa do Dashboard Gerente - Menu principal de ferramentas
 */
...
// Buscar dados para a página Mais Opções
try {
...
<body class="bg-gray-50">
    <div class="w-full min-h-screen bg-white">
        ...
        <div class="flex items-center justify-between p-6 bg-white sticky top-0 z-10 shadow-sm border-b border-gray-200">
            ...
            <a href="gerente-completo.php" class="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 rounded-xl transition-all duration-200 shadow-sm">
    ...
    <script>
        // Carregar modal-loader.js para abrir subpáginas como modais
        if (typeof window.openModal === 'undefined') {
            const script = document.createElement('script');
            script.src = 'assets/js/modal-loader.js';
            document.head.appendChild(script);
        }
        
        function openSubPage(page) {
            // Se modal-loader.js estiver disponível, usar modal
            if (typeof window.openModal === 'function') {
                window.openModal(page, { fullscreen: true });
            } else {
                // Fallback: redirecionar para a página diretamente
                window.location.href = 'subs/' + page + '.php';
            }
        }
    </script>
</body>
