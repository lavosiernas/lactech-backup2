...
-- --------------------------------------------------------
-- 3. ADICIONAR CAMPO LOGO NA TABELA FARMS
-- --------------------------------------------------------
-- Adicionar campo para armazenar o caminho da logo da fazenda

-- Verificar e adicionar logo_path se não existir
SET @col_exists = (
    SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS 
    WHERE TABLE_SCHEMA = @dbname 
...
SELECT 'Todas as alterações concluídas!' AS resultado;
